...
public sealed record GatherOpportunity(
    ...
    double EstimatedUnitsPerActiveMinuteLow,
    double EstimatedUnitsPerActiveMinuteHigh,
    double EstimatedGilPerActiveMinute,
    double EstimatedGilPerActiveMinuteLow,
    double EstimatedGilPerActiveMinuteHigh,
    double? SalePriceVolatility,
    int SalesSampleCount,
    DateTimeOffset? LastSaleUtc,
    IReadOnlyList<string> Notes,
